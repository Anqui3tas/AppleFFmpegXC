...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cc=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.1.sdk --extra-cflags='-arch arm64 -mmacosx-version-min=12.0 -fdata-sections -ffunction-sections -fmax-type-align=16' --extra-ldflags='-arch arm64 -mmacosx-version-min=12.0 -Wl,-sectalign,__DATA,__common,0x4000 -framework Security -framework CoreFoundation' --prefix=/Users/quentin/Documents/AppleFFmpegXC/build/out/macos-arm64 --enable-cross-compile --enable-static --disable-shared --disable-programs --disable-doc --enable-pic --disable-autodetect --enable-videotoolbox --enable-securetransport --disable-filter=zscale --enable-protocol='file,https,tcp,tls' --enable-demuxer='mov,matroska,mpegts,hls,flv' --enable-muxer='mp4,matroska,mpegts,hls,segment' --enable-parser='h264,hevc,aac,ac3,eac3,truehd,dca' --enable-decoder='h264,hevc,eac3,truehd,ac3,aac,alac,flac,opus,vorbis,mp3,dca,pcm_s16le,pcm_s24le,pgssub,ass,srt' --enable-filter='aresample,afloudnorm,anlmdn,pad,scale,scale_videotoolbox,zscale,tonemap'
prefix=/Users/quentin/Documents/AppleFFmpegXC/build/out/macos-arm64
...
CC_IDENT=Apple clang version 17.0.0 (clang-1700.4.4.1)
ARCH=aarch64
INTRINSICS=neon
EXTERN_PREFIX=_
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.1.sdk -D_ISOC11_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.1.sdk -DPIC -I$(SRC_PATH)/compat/stdbit
CFLAGS=  -arch arm64 -mmacosx-version-min=12.0 -fdata-sections -ffunction-sections -fmax-type-align=16 -std=c17 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -arch arm64 -mmacosx-version-min=12.0 -fdata-sections -ffunction-sections -fmax-type-align=16 -fPIC -g -Qunused-arguments
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -arch arm64 -mmacosx-version-min=12.0 -Wl,-sectalign,__DATA,__common,0x4000 -framework Security -framework CoreFoundation  --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.1.sdk -Wl,-dynamic,-search_paths_first -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.1.sdk -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avfilter=-pthread -lm -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
